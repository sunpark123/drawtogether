...
function SaveChecker ({ setSaveOverWriteChecker, saveDrawHistoryRequest }) {
            ...
            <div className="SaveChecker">
                <div className='block' style={{backgroundImage: "url('background.jpg') "}}>
                    <div className='menuWrap'>
                        <div className="menu" onClick={() => saveDrawHistoryRequest()} onMouseMove={(e) => handleMouseMove(1, e)}  onMouseLeave={() => resetStyle(1)} style={{
                            transform: (style.number === 1) ? style.transform : 'none',
                            background: (style.number === 1) ? style.background : 'rgba(255, 255, 255, 0.8)'
                        }}>
                            <img src="noneDrawImage.png" style={{ height: "30px" }} alt="gameIcon"></img>
                            <h1 style={{ color:"blue" }}>{l("saved_overwrite_yes")}</h1>
                            <p>{l("saved_overwrite_info")}</p>
                        </div>
                        <div className="menu" onClick={() => setSaveOverWriteChecker(-1)} onMouseMove={(e) => handleMouseMove(2, e)}  onMouseLeave={() => resetStyle(2)} style={{
